...
public class MainActivity extends SlidingFragmentActivity implements
	...
	public  void showdia(String title, String str)
	{
		...
		com.fyzs.tool.CustomDialog.Builder builder = new com.fyzs.tool.CustomDialog.Builder(com.fyzs.activity.MainActivity.this);
				...
				if(!result.equals("0"))
				{
					try {
						...
						if(jsarr.length()!=infos.size())//有更新
						{
							...
							Intent intent=new Intent(com.fyzs.activity.MainActivity.this,MessageActivity.class);
							PendingIntent pi= PendingIntent.getActivity(com.fyzs.activity.MainActivity.this,0,intent,0);
							NotificationManager manager= (NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE);
							Notification notification=new NotificationCompat.Builder(com.fyzs.activity.MainActivity.this)
		...
		public void handleMessage(Message msg) {
			...
			switch (msg.what) {
				...
				case DOWN_ERROR:
					// 下载apk失败
					handler.sendEmptyMessage(8);
					Toast.makeText(com.fyzs.activity.MainActivity.this, "下载新版本失败", 1).show();
					break;
				case 5:
	...
	protected void showUpdataDialog() {
		AlertDialog.Builder builer = new Builder(com.fyzs.activity.MainActivity.this);
	...
	protected void downLoadApk() {
		...
		pd = new ProgressDialog(com.fyzs.activity.MainActivity.this);
