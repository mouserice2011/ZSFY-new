...
public class QueryzaocaoActivity extends Activity {
    ...
    private ImageHandler handler = new ImageHandler(new WeakReference<com.fyzs.activity.QueryzaocaoActivity>(this));
...
//        this.bv.loadAD();
        ...
        bt_zaocao_query.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (str.isEmpty()) {
                    Toast.makeText(com.fyzs.activity.QueryzaocaoActivity.this, "请输入学号", Toast.LENGTH_SHORT).show();
                    return;
                }
                tv_name1.setText("姓名");
                tv_name2.setText("班级");
                tv_name3.setText("次数");
                /* 显示ProgressDialog */
                pd = ProgressDialog.show(com.fyzs.activity.QueryzaocaoActivity.this, "",
                        "查询中，请稍后……");
    ...
    public void detail(View v) {
        ...
        final String str = ed_search.getText().toString().trim();
        if (str.isEmpty()) {
            Toast.makeText(com.fyzs.activity.QueryzaocaoActivity.this, "请输入学号", Toast.LENGTH_LONG).show();
            return;
        }
        tv_name1.setText("序号");
        tv_name2.setText("姓名");
            ...
            if (msg.what == 0) {//打卡次数
                ...
                try {
                    ...
                    if (json.getString("name").equals("0")) {
                        Toast.makeText(com.fyzs.activity.QueryzaocaoActivity.this, "暂无查询到相关信息！",
                                Toast.LENGTH_SHORT).show();
                    } else if (json.getString("name").equals("1")) {
                        Toast.makeText(com.fyzs.activity.QueryzaocaoActivity.this, "网络请求超时", 0)
                                .show();
                    } else {//有信息
                ...
                Toast.makeText(com.fyzs.activity.QueryzaocaoActivity.this, "网络请求超时", 0).show();
            }
        }
    };
    ...
    class Myadapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            View view1 = View.inflate(com.fyzs.activity.QueryzaocaoActivity.this, R.layout.list_daka, null);
    ...
    private static class ImageHandler extends Handler {
        ...
        private WeakReference<com.fyzs.activity.QueryzaocaoActivity> weakReference;
        private int currentItem = 0;

        protected ImageHandler(WeakReference<com.fyzs.activity.QueryzaocaoActivity> wk) {
            weakReference = wk;
        }
        ...
        public void handleMessage(Message msg) {
            ...
            com.fyzs.activity.QueryzaocaoActivity activity = weakReference.get();
            if (activity == null) {
