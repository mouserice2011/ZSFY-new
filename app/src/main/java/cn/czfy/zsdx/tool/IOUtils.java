...
public class IOUtils {
	/**
	 * ?* 指定编码格式 ，把输入流转化为字符串 ?* ?* @param is ?* @return ?* @throws IOException ?
	 */
	...
	/**
	 * ?* 下载图片 ?* ?* @param urlString ?* @param filename ?* @param savePath ?* @throws
	 * Exception ?
	 */
	...
	/**
	 * ?* 图片裁剪工具类 ?* ?* @param src ?* @param dest ?* @param x ?* @param y ?* @param
...
//	}
	...
	/**
	 * ?* 把输入流转换成图片---》获取验证码 ?* ?* @param is ?* @param filename ?* @param
	...
	/**
	 * ?* 获取隐藏字段的__VIEWSTATE值 ?* ?* @param url ?* @param cookie ?* @param
