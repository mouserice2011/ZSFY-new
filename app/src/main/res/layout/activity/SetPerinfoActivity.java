    ...
    protected void showChoosePicDialog() {
        ...
        builder.setItems(items, new
                ...
                /* 取得相片后返回本画面 */
                            ...
                            case 1: // 默认头像
                                touxiangpath = "";
                                SharedPreferences sp1 = com.fyzs.activity.SetPerinfoActivity.this.getSharedPreferences(
                                        "StuData", 0);
                                String sex = sp1.getString("sex", "男");
                                if (sex.equals("男")) {
                                    profile_image1.setImageResource(R.drawable.boy);
    ...
    private void upload(String imgpath) {
        ...
        icon.uploadblock(this, new UploadFileListener() {
            ...
            public void onSuccess() {
                ...
                person.setXh(com.fyzs.activity.SetPerinfoActivity.this.getSharedPreferences(
                        "StuData", 0).getString("xh", "2014491022"));
                person.save(com.fyzs.activity.SetPerinfoActivity.this);
                Toast.makeText(com.fyzs.activity.SetPerinfoActivity.this, "图片上传成功：", Toast.LENGTH_SHORT).show();
            }
            ...
            public void onFailure(int arg0, String arg1) {
                // TODO Auto-generated method stub
                Toast.makeText(com.fyzs.activity.SetPerinfoActivity.this, "图片上传失败：" + arg1, Toast.LENGTH_SHORT).show();
            }
        });
    }
