...
public class LoginActivity extends Activity {
	...
	public static com.fyzs.activity.LoginActivity _instance = null;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (shp.getBoolean(MyConstants.FIRST, false)) {
			Intent intent = new Intent(com.fyzs.activity.LoginActivity.this, MainActivity.class);
			startActivity(intent);
			finish();
		} else {
		}
		...
		tv_login_about.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				com.fyzs.tool.ChengjiDialog.Builder builder = new com.fyzs.tool.ChengjiDialog.Builder(
						com.fyzs.activity.LoginActivity.this);
	...
	public void login(View view) {
		...
		pd = ProgressDialog.show(com.fyzs.activity.LoginActivity.this, "", "登录中，请稍后……");// 等待的对话框
		...
		new Thread() {
			public void run() {
				...
				case "教师":
				{
					...
					et.commit();
					ok=CookieHttp.Login(xh, pwd, com.fyzs.activity.LoginActivity.this); // 8秒后没有连接上服务器
					break;
				}
				case "学生":
				{
	...
	public void showToastInAnyThread(final String text) {
		runOnUiThread(new Runnable() {
			@Override
			public void run() {
				Toast.makeText(com.fyzs.activity.LoginActivity.this, text, 0).show();
			}
		});
	}
...
//					};
//				}.start();
				Intent intent = new Intent(com.fyzs.activity.LoginActivity.this,
						YzmActivity.class);
				startActivity(intent);
