...
public class LibraryActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		bt_top_return.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				SaveBookData.clear1();
				com.fyzs.activity.LibraryActivity.this.finish();
			}
		});
		tv_uppage.setOnClickListener(new OnClickListener() {// 上一页
					...
					public void onClick(View v) {
						// TODO Auto-generated method stub
						if (pageNum == 1) {
							Toast.makeText(com.fyzs.activity.LibraryActivity.this, "已经是第一页", 0)
									.show();
							return;
						}
						pageNum--;
		...
		tv_nextpage.setOnClickListener(new OnClickListener() {// 下一页
					...
					public void onClick(View v) {
						// TODO Auto-generated method stub
						if (pageNum == maxNum) {
							Toast.makeText(com.fyzs.activity.LibraryActivity.this, "已经是最后一页", 0)
									.show();
							return;
						}
						pageNum++;
		...
		lv_lib.setOnItemClickListener(new OnItemClickListener() {// 点击事件
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				// TODO Auto-generated method stub
				pd = ProgressDialog.show(com.fyzs.activity.LibraryActivity.this, "", "加载中，请稍后……");
	...
	Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {// handler接收到消息后就会执行此方法
			pd.dismiss();// 关闭ProgressDialog
			if (msg.what == 1) {
				Intent intent = new Intent(com.fyzs.activity.LibraryActivity.this,
						com.fyzs.activity.DetailBookActivity.class);
	...
	private class myAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			View view = View.inflate(com.fyzs.activity.LibraryActivity.this, R.layout.lib_list,
					null);
	...
	public void showToastInAnyThread(final String text) {
		runOnUiThread(new Runnable() {
			@Override
			public void run() {
				Toast.makeText(com.fyzs.activity.LibraryActivity.this, text, 0).show();
			}
		});
	}
}
