	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tv_uppage.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (nowIndex == 0) {
					Toast.makeText(com.fyzs.activity.DJDatiActivity.this, "已经是第一题", 0).show();
				} else {
		...
		tv_nextpage.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (nowIndex == 19) {
					...
					com.fyzs.tool.ChengjiDialog.Builder builder = new com.fyzs.tool.ChengjiDialog.Builder(com.fyzs.activity.DJDatiActivity.this);
