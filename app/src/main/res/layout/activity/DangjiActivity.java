...
public class DangjiActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lv_dj.setOnItemClickListener(new OnItemClickListener() {// 点击事件
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent=new Intent(com.fyzs.activity.DangjiActivity.this, com.fyzs.activity.DJDatiActivity.class);
	...
	private class myAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			View view = View.inflate(com.fyzs.activity.DangjiActivity.this, R.layout.list_dangji, null);
